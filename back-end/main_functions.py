def check_weekday(date):
    ...
    if date_week in [0, 1, 2, 3, 4]: # to do: explicar essa lógica
        return "weekday"
    else:
        return "weekend"
    
#to do: transformar isso em um grande loop???
...
def calculate_prices(small_dogs, big_dogs, date_week):
    ...
    petshops.sort(key=lambda shop: (shop["price"], shop["distance"])); # to do: explicar
    petshop = petshops[0]
